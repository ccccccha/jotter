      ...
      <div className="bg-white min-h-screen text-black">
        <div className="max-w-[90rem] mx-auto px-6 md:px-12">
          ...
          <main className="max-w-md mx-auto mt-20">
            <h1 className="text-3xl font-modern font-bold mb-2 text-center">Create Account</h1>
            ...
            <div className="bg-white border border-neutral-300 rounded-2xl p-8 shadow-sm">
              ...
              <div className="mt-6 text-center">
                <p className="text-sm font-modern text-gray-600">
                  ...
                  <a href="/login" className="text-black font-semibold underline underline-offset-2 hover:text-gray-600 transition-colors cursor-pointer">
                    Log in
                  </a>
                </p>
              </div>
